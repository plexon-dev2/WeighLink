 ...
 */
#define MODBUS_HOLDING_REG_COUNT 	12
...
// #define MODBUS_FC_WRITE_SINGLE_REG   0x06    // Write Single Register (future)
// #define MODBUS_FC_WRITE_MULTIPLE_REGS 0x10   // Write Multiple Registers (future)
