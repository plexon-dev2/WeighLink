 ...
 * @details Maximum length of Sansui weighing scale data message including special characters
 * @note Changed from fixed 167 to 300 because the machine sends variable length
 *       strings depending on weight value and field padding. Using 300 as safe maximum.
 */
 ...
 * @note Changed from 50 to 500 - previous value was causing rejection
 *       of any weight above 50kg. Adjust based on actual scale capacity.
 */
